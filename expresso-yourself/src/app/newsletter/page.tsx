...
type User = {
    ...
    email: string;
    user_id: number;
    is_admin: number | boolean; // Added is_admin field to match home page
};
...
export default function Newsletter() {
    ...
    useEffect(() => {
        if (subscribeStatus.message) {
            const timer = setTimeout(() => {
                setSubscribeStatus({ type: null, message: null });
            }, 3000);
            return () => clearTimeout(timer);
        }
    }, [subscribeStatus]);
                ...
                <div className="copy">
                    ...
                    <div className='right'>
                        <form className="contact-form" onSubmit={handleNewsletterSubmit}>
                            ...
                            <button type="submit" className="send-button-help">SUBSCRIBE</button>
